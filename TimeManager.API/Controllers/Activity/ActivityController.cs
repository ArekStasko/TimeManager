...
namespace TimeManager.API.Controllers.vwActivityCategoryControllers
{
    ...
    public class ActivityController : ControllerBase, IActivityController
    {
        ...
        {
            IvwActivityCategory_GetAll vwActivityCategory_GetAll = vwActivityCategoryProcessor_Factory.GetvwActivityCategory_GetAll(_context);
        ...
        {
            IvwActivityCategory_GetById vwActivityCategory_GetById = vwActivityCategoryProcessor_Factory.GetvwActivityCategory_GetById(_context);
        ...
        {
            IvwActivityCategory_GetByCategory vwActivityCategory_GetByCategory = vwActivityCategoryProcessor_Factory.GetvwActivityCategory_GetByCategory(_context);
        ...
        {
            IActivity_Add vwActivityCategory_Add = vwActivityCategoryProcessor_Factory.GetvwActivityCategory_Add(_context);
        ...
        {
            IActivity_Delete vwActivityCategory_Delete = vwActivityCategoryProcessor_Factory.GetvwActivityCategory_Delete(_context);
        ...
        {
            IActivity_Update vwActivityCategory_Update = vwActivityCategoryProcessor_Factory.GetvwActivityCategory_Update(_context);
